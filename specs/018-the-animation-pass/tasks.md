...
| T1605 (`sdd-implementer`)                                   | `opus` (Opus 5.5)              | 94,878                      | done; 377 tests; geometry identical before/after and to 017's records on both screens; groups at 480 / move curve; flag and RM reads as specified; quiet arrow fetches only the 100vw candidate; leaving quiet at 1512 then fetches the page's w828 — as the control without the listener does (moved, not added; for the phase review); describe is (i) not (h) |
