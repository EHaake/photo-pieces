...
- [x] **T1606g** — Round (third look, 2026-09-23): "I would like some
...
- [x] **T1606h** — Round (third look, 2026-09-23): "I was thinking that
...
- [x] **T1607** — Docs: `design/brief.md`, `README.md`, `AUTHORING.md`,
...
- [x] **T1608** — Close-out. The repo-wide documents are edited by
...
- [x] **T1608a** — Pre-merge sweep fixes. B1: the
...
| T1606h (`sdd-implementer`)                                      | `opus` (Opus 5.5)              | 128,531                     | done; 407 tests; carousel machine-checked (dev + preview, both screens, normal/quiet, next/prev, back/forward): old wholly off at the end, new wholly off at 0, opacity 1, no group morph, header z-index 1; flag 0 root only; RM and no-API clean                                                                                                                                                                                                                                                                                                                                                                |
| T1606h per-task review (`skeptical-reviewer`)                   | `opus` (Opus 5.5)              | 33,428                      | signed off; the second screen was read at 390×844, not 1280×1440 (width-only geometry; recorded); header-above-slide read from computed z-index, not paint — the person attests                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| T1608a (`sdd-implementer`)                                      | `opus` (Opus 5.5)              | 83,817                      | RM block moved to the file's end; the order pin fails with it back; `--rm-appear: 0` → 0s (old CSS 0.95s), 1 → 0.95s; other RM rules still win; comments, ROADMAP, README, brief fixed; 408 tests                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Sweep re-review (`skeptical-reviewer`, resumed)                 | `opus` (Opus 5.5)              | 253,371 cumulative          | signed off on condition: the person's screens/devices answer replaces the template paragraph before the merge. Open caveats to the record: the unlinked-strip branch unverified (no fixture); T1604c's ≤14px mono-font move below the fold on the first swap into an image page; T1606h's header-above-slide read from computed z-index, not paint                                                                                                                                                                                                                                                                |
| Merge (orchestrator)                                            | session `claude-opus-5-5`      | —                           | PR #18 merged with a merge commit (ea704ae), 2026-09-24; main green (408 tests); the role table restored to the standard profile at the person's word; ROADMAP gains "A mobile design pass"                                                                                                                                                                                                                                                                                                                                                                                                                       |
