...
- [x] **T1301a** — Record corrections from T1301's per-task review
      ...
      separate on purpose — merging them fails the "declared once" test.
...
| T1305a (`sdd-implementer`)                          | implementation (`opus`, high)    | 58,568  | done first dispatch; plan.md had no duplicate sentence (it was tasks.md's T1305 line, fixed by the orchestrator) |
